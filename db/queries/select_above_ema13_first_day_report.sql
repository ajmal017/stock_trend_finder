...
select ticker_symbol, price_date, high, low, ema13, candle_vs_ema13, round(volume/average_volume_50day, 2) as volume_ratio from daily_stock_prices dsp
where
candle_vs_ema13='above' and
close > open and
price_date='2014-07-01' and
